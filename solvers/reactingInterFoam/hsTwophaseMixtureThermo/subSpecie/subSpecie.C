...
:
    ...
    evapDict_(subSpecieDict_.subOrEmptyDict("evaporation")),
    Y_(specie),
    thermo_(specieData),
    idx_(idx),
    ...
    kappa_(subSpecieDict.lookupOrDefault("kappa",dimensionedScalar("kappa",dimPower/dimLength/dimTemperature,0.0)))
{
    ...
    sigmaLJ_ = (subSpecieDict_.found("sigmaLJ")) ? readScalar(subSpecieDict_.lookup("sigmaLJ")) : 0;
    TLJ_ = (subSpecieDict_.found("TLJ")) ? readScalar(subSpecieDict_.lookup("TLJ")) : 0;
    ...
    Foam::Info<< "  sigmaLJ = " << sigmaLJ_ << Foam::endl;
    Foam::Info<< "  TLJ = " << TLJ_ << Foam::endl;
